...
#         seq_id = torch.Tensor([int(s.split('.')[0]) for s in input_dict['ifc_helpers']['csv_file']])
#         return {"preds" : preds, "seq_id" :seq_id}
    
#     def test_end(self, outputs):
#         write_h5 = {}
#         for output in outputs:
#             for i in range (len(output['seq_id'])):
#                 write_h5[output['seq_id']] = output['preds'].tolist()
            
# #             print(output.keys())
# #             print(output['preds'].shape)
# #             print(output['seq_id'])
# #             print("="*100)
# #             # dict_keys(['preds', 'seq_id'])
# #             # torch.Size([3, 1, 6, 30, 3])
# #             # ['12340.csv', '1234.csv', '12342.csv']
#         os.makedirs(self.hparams.save_dir, exist_ok=True)

#         generate_forecasting_h5(write_h5, self.hparams.save_dir) #this might take awhile
